              ...
              >
                ...
                <div className="p-5 px-3 flex flex-col justify-between">
                  ...
                  <div className="flex justify-end">
                    <button className="mt-4 flex items-center gap-2 text-green-600 font-medium text-sm group-hover:underline">
                      Leer más{" "}
                ...
                {/* Borde decorativo */}
                <div className="absolute inset-0 border-2 border-transparent group-hover:border-green-500/40 rounded-2xl transition-all duration-300 pointer-events-none"></div>
              </motion.div>
            );
          })}
        </div>
